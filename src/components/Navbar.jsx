  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5 flex items-center justify-between">
        <button onClick={() => handleNavClick('/')} className="flex items-center gap-2 leading-none">
        ...
        <div className="flex items-center gap-3">
          <button onClick={() => handleNavClick('/contact')} className="hidden md:block px-5 py-2.5 bg-gradient-to-r from-cyan-500 to-blue-600 text-white text-sm font-medium rounded-full shadow-[0_8px_22px_rgba(6,182,212,0.35)] ring-1 ring-cyan-200/30 hover:shadow-[0_12px_28px_rgba(6,182,212,0.45)] transition-all hover:scale-105">
            Get Started
          </button>
